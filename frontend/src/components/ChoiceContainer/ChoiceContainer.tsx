...
const choiceCards = [
  {
    imgPath: "/assets/weather-icon.png",
    imgAlt: "прогноза",
...
export default function ChoiceContainer({ wantedCity }: ChoiceContainerProps) {
